...
typedef struct sSX1276LR
{
    ...
    // Additional settings
    uint8_t RegTestReserved43;                      // 0x43 Î´¶¨Òå
    uint8_t RegPllHop;                              // 0x44
    uint8_t RegTestReserved45[0x4a - 0x45];         // 0x45-0x4a Ìî¿Õ
    
    uint8_t RegTcxo;                                // 0x4b
    uint8_t RegTestReserved4c;                      // 0x4c Î´¶¨Òå
    uint8_t RegPaDac;                               // 0x4D

    uint8_t RegTestReserved4e[0x5b - 0x4e];         // 0x4e-0x5a Ìî¿Õ
    
    uint8_t RegFormerTemp;                          // 0x5b
    uint8_t RegTestReserved5c;                      // 0x5c Î´¶¨Òå
    uint8_t RegBitrateFrac;                         // 0x5d
    uint8_t RegTestReserved5e[0x61 - 0x5e];         // 0x5e-0x60 Ìî¿Õ
    uint8_t RegAgcRef;                              // 0x61
    uint8_t RegAgcThresh1;                          // 0x62
    uint8_t RegAgcThresh2;                          // 0x63
    uint8_t RegAgcThresh3;                          // 0x64

    uint8_t RegTestReserved65[0x70 - 0x65];         // 0x65-0x6f Ìî¿Õ
    uint8_t RegPllHf;                               //0x70
}tSX1276LR;
